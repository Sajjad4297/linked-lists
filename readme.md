...
```
آدرس هر گره:  1001         1020          1190
گره ها:    [10|1020] -> [20|1190] -> [30|Next] -> None
```

- <b>Head</b>: اولین 'گره' لیست
- <b>Tail</b>: آخرین 'گره' که اشاره‌گرش `null` است
...
- افزودن یا حذف 'گره'ها آسان‌تر از آرایه است.
...
- انتهای لیست: تغییر Next 'گره' Tail
...
### حذف 'گره'
- تغییر اشاره‌گر 'گره' قبل، 'گره' حذف می‌شود
